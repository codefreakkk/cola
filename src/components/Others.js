...
function Others({ closeBar }) {

    return (
        <>
            <div class="menu-content">
                <span class="menu-heading fw-bold text-uppercase fs-7" style={{ color: '#b3b3b3', opacity: .5, display: closeBar ? 'none' : '' }}>Others</span>
            </div>
            ...
            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                <span class="menu-link">
                    ...
                    <NavLink to="/issues" style={({ isActive }) => (isActive ? { color: 'white' } : { color: '#9D9DA6' })}><span class="menu-title" style={{ cursor: 'pointer', display: closeBar ? 'none' : '' }}>Issues</span></NavLink>
            ...
            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                <span class="menu-link">
                    ...
                    <NavLink to="/messages" style={({ isActive }) => (isActive ? { color: 'white' } : { color: '#9D9DA6' })}><span class="menu-title" style={{ cursor: 'pointer', display: closeBar ? 'none' : '' }}>Messages</span></NavLink>
                    {/* <span class="menu-title" style={{ color: 'white', cursor: 'pointer' }}>Inbox</span> */}
                </span>
            </div>
        </>
